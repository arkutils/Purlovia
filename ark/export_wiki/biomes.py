...
from .common import format_location_for_export, get_volume_worldspace_bounds, proxy_properties_as_dict
from .map import WorldData
from .types import BIOME_VOLUME_ALWAYS_EXPORTED_PROPERTIES, BIOME_VOLUME_EXPORTED_PROPERTIES, BiomeZoneVolume
...
def extract_biome_zone_volume(world: WorldData, proxy: BiomeZoneVolume) -> dict:
    ...
    return {
        ...
        **proxy_properties_as_dict(proxy, key_list=BIOME_VOLUME_EXPORTED_PROPERTIES, only_overriden=True), 'boxes': {
